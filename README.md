...
"com.github.sebruck" %% "opencensus-scala-akka-http" % "0.7.0-M2" 

// If you want to use opencensus-scala inside a http4s project 
"com.github.sebruck" %% "opencensus-scala-http4s" % "0.7.0-M2" 

// If you want to use opencensus-scala inside a elastic4s project 
"com.github.sebruck" %% "opencensus-scala-elastic4s" % "0.7.0-M2" 
```
